...
public:
  ...
  inline void SetMomentumDirection(const G4ThreeVector& momentumDirection) { fMomentumDirection = momentumDirection; }
  inline G4ThreeVector& GetMyMomentumDirection() { return fMomentumDirection; }
  ...
  inline void SetCopyNumber(G4int copyNumber){fCopyNumber = copyNumber;}
  inline G4int GetCopyNumber() const {return fCopyNumber;}

  inline void SetMyParticleEnergy(G4double partEnergy){
    fPartEnergy = partEnergy;}
  inline G4double GetMyParticleEnergy() const{
    return fPartEnergy;}

  inline void SetIsBoundry(G4bool isBoundry){
    fIsBoundry = isBoundry;
}
  inline G4double GetIsBoundry()const {
    return fIsBoundry;}
